...
static void Configure_I2C_TRISE(I2C_Handle_t *p_i2c_handle);
...
void I2C_Init(I2C_Handle_t *p_i2c_handle)
{
	...
	// configure TRISE
	Configure_I2C_TRISE(p_i2c_handle);
